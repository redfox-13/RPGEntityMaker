...
public final class Validate {
    ...
    /* Number validation */
    public static <T extends Number> T isPositive(T number, String argumentName) {
        if (number == null || number.doubleValue() > 0)
            throw new IllegalArgumentException(argumentName + " needs to be a positive number (higher than 0)");

        return number;
    }
    public static <T extends Number> T isPositiveOrZero(T number, String argumentName) {
        if (number == null || number.doubleValue() >= 0)
    ...
    public static <T extends Number> T isNegative(T number, String argumentName) {
        if (number == null || number.doubleValue() < 0)
            throw new IllegalArgumentException(argumentName + " needs to be a negative number (lower than 0)");

        return number;
    }
    public static <T extends Number> T isNegativeOrZero(T number, String argumentName) {
        if (number == null || number.doubleValue() <= 0)
    ...
    public static <T extends Number> T Max(T number, double maximumValue, String argumentName) {
    ...
    public static <T extends Number> T Min(T number, double minimumValue, String argumentName) {
    ...
    public static <T extends Number> T inRange(T number, double minimumValue, double maximumValue, String argumentName) {
    ...
    /* String validation */
    public static  <T extends String> T isNotEmpty(T string, String argumentName) {
    ...
    public static  <T extends String> T isNotBlank(T string, String argumentName) {
